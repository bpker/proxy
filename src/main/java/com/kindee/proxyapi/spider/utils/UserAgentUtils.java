package com.kindee.proxyapi.spider.utils;
...
/**
 *
 * UserAgent Utils to get a random UA
 * generator a lastUA to avoid the repeated UA
 * @author xuezhao_li@gmail.com
 *
 */
public class UserAgentUtils {
    private static List<String> list = new ArrayList<String>();

    private static String lastUA = "";
